...
const List = () => {
  ...
  const {data, loading ,error, reFetch}=useFetch(`http://localhost:5000/api/hotels?city=${destination}&min=${min ||1}&max=${max ||90000}`)
  const handleSearch=()=>{
    reFetch()
  }
  return (
      ...
      <div className="listContainer">
        <div className="listWrapper">
          <div className="listSearch">
            ...
            {openDate&&<DateRange onChange={(i)=>setDates([i.selection])} minDate={new Date()} ranges={dates} />}
            </div>
            <div className="lsItem">
